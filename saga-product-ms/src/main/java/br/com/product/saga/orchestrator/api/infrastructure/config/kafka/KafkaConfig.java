package br.com.product.saga.orchestrator.api.infrastructure.config.kafka;
...
public class KafkaConfig {
  ...
  public NewTopic productValidationSuccessTopic() {
    return buildTopic(props.kafka().topic().productValidationSuccess());
  }

  @Bean
  public NewTopic productValidationFailTopic() {
    return buildTopic(props.kafka().topic().productValidationFail());
  }
}
