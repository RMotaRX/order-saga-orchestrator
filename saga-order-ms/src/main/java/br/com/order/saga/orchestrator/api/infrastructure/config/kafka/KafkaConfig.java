package br.com.order.saga.orchestrator.api.infrastructure.config.kafka;
...
public class KafkaConfig {
  ...
  public NewTopic startSagaTopic() {
    return buildTopic(props.kafka().topic().startSaga());
  }

  @Bean
  public NewTopic notifyEndingTopic() {
    return buildTopic(props.kafka().topic().notifyEnding());
  }
}
