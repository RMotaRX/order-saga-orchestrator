package br.com.payment.saga.orchestrator.api.infrastructure.config.kafka;
...
public class KafkaConfig {
  ...
  public NewTopic paymentSuccessTopic() {
    return buildTopic(props.kafka().topic().paymentSuccess());
  }

  @Bean
  public NewTopic paymentFailTopic() {
    return buildTopic(props.kafka().topic().paymentFail());
  }
}
